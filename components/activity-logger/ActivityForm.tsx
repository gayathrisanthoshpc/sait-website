      ...
      <form onSubmit={onSubmit} className="space-y-4">
        <div className="grid gap-4 md:grid-cols-2">
          <label className="block text-sm font-medium text-[#1F2A44]">
            ...
            <input
              ...
              className="w-full rounded-full border border-[#1F2A44]/10 bg-[#F7F3EB] px-4 py-3 text-sm text-[#1F2A44] placeholder:text-[#1F2A44]/35 focus:border-[#1F2A44] focus:outline-none focus:ring-2 focus:ring-black/10"
          ...
          <label className="block text-sm font-medium text-[#1F2A44]">
            ...
            <select
              ...
              className="w-full rounded-full border border-[#1F2A44]/10 bg-[#F7F3EB] px-4 py-3 text-sm text-[#1F2A44] focus:border-[#1F2A44] focus:outline-none focus:ring-2 focus:ring-black/10"
        ...
        <label className="block text-sm font-medium text-[#1F2A44]">
          ...
          <textarea
            ...
            className="min-h-[120px] w-full rounded-[1.5rem] border border-[#1F2A44]/10 bg-[#F7F3EB] px-4 py-3 text-sm text-[#1F2A44] placeholder:text-[#1F2A44]/35 focus:border-[#1F2A44] focus:outline-none focus:ring-2 focus:ring-black/10"
        ...
        <div className="flex flex-col gap-4 pt-2 sm:flex-row sm:items-center sm:justify-between">
          <button
            type="submit"
            className="inline-flex items-center justify-center rounded-full bg-[#1F2A44] px-6 py-3 text-sm font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#C6A75E] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1F2A44]"
          >
            Submit Activity
          </button>
